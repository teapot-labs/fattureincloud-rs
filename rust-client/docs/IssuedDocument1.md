...
**entity** | Option<[**crate::models::Entity1**](Entity_1.md)> |  | [optional]
...
**language** | Option<[**crate::models::Language1**](Language_1.md)> |  | [optional]
...
**rivalsa** | Option<**f32**> | Issued document \"Rivalsa INPS\" percentual value | [optional]
**cassa** | Option<**f32**> | Issued document \"Cassa previdenziale\" percentual value | [optional]
**amount_cassa** | Option<**f32**> | [Read Only] Issued document cassa amount. | [optional][readonly]
**cassa_taxable** | Option<**f32**> | Issued document cassa taxable percentage | [optional]
**amount_cassa_taxable** | Option<**f32**> | [Can be set only if cassa_taxable is NULL] Issued document cassa taxable amount | [optional]
**cassa2** | Option<**f32**> | Issued document \"Cassa previdenziale 2\" percentual value | [optional]
**amount_cassa2** | Option<**f32**> | [Read Only] Issued document cassa2 amount | [optional][readonly]
**cassa2_taxable** | Option<**f32**> | Issued document cassa2 taxable percentage | [optional]
**amount_cassa2_taxable** | Option<**f32**> | [Can be set only if cassa2_taxable is NULL] Issued document cassa2 taxable amount | [optional]
**global_cassa_taxable** | Option<**f32**> | Issued document global cassa taxable percentage | [optional]
**amount_global_cassa_taxable** | Option<**f32**> | [Can be set only if global_cassa_taxable is NULL] Issued document global cassa taxable amount | [optional]
**withholding_tax** | Option<**f32**> | Issued document withholding tax (ritenuta d'acconto) percentual value | [optional]
**withholding_tax_taxable** | Option<**f32**> | Issued document withholding tax taxable (imponibile) percentual value | [optional]
**other_withholding_tax** | Option<**f32**> | Issued document other withholding tax (altra ritenuta) percentual value | [optional]
**stamp_duty** | Option<**f32**> | Issued document stamp duty value [0 if not present] | [optional]
**payment_method** | Option<[**crate::models::PaymentMethod4**](PaymentMethod_4.md)> |  | [optional]
...
**ei_data** | Option<[**crate::models::IssuedDocumentEiData**](IssuedDocument_ei_data.md)> |  | [optional]
