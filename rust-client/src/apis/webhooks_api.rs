...
pub async fn create_webhooks_subscription(configuration: &configuration::Configuration, company_id: i32, create_webhooks_subscription_request: Option<crate::models::CreateWebhooksSubscriptionRequest>) -> Result<crate::models::CreateWebhooksSubscriptionResponse, Error<CreateWebhooksSubscriptionError>> {
...
pub async fn get_webhooks_subscription(configuration: &configuration::Configuration, company_id: i32, subscription_id: &str) -> Result<crate::models::GetWebhooksSubscriptionResponse, Error<GetWebhooksSubscriptionError>> {
    let local_var_configuration = configuration;
...
pub async fn list_webhooks_subscriptions(configuration: &configuration::Configuration, company_id: i32) -> Result<crate::models::ListWebhooksSubscriptionsResponse, Error<ListWebhooksSubscriptionsError>> {
    let local_var_configuration = configuration;
...
pub async fn modify_webhooks_subscription(configuration: &configuration::Configuration, company_id: i32, subscription_id: &str, modify_webhooks_subscription_request: Option<crate::models::ModifyWebhooksSubscriptionRequest>) -> Result<crate::models::CreateWebhooksSubscriptionRequest1, Error<ModifyWebhooksSubscriptionError>> {
    let local_var_configuration = configuration;
