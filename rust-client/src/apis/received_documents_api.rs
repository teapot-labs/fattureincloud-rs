...
pub async fn create_received_document(configuration: &configuration::Configuration, company_id: i32, create_received_document_request: Option<models::CreateReceivedDocumentRequest>) -> Result<models::CreateReceivedDocumentResponse, Error<CreateReceivedDocumentError>> {
...
pub async fn get_existing_received_document_totals(configuration: &configuration::Configuration, company_id: i32, document_id: i32, get_existing_received_document_totals: Option<models::GetExistingReceivedDocumentTotals>) -> Result<models::GetExistingReceivedDocumentTotalsResponse, Error<GetExistingReceivedDocumentTotalsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_new_received_document_totals(configuration: &configuration::Configuration, company_id: i32, get_new_received_document_totals_request: Option<models::GetNewReceivedDocumentTotalsRequest>) -> Result<models::GetNewReceivedDocumentTotalsResponse, Error<GetNewReceivedDocumentTotalsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_received_document(configuration: &configuration::Configuration, company_id: i32, document_id: i32, fields: Option<&str>, fieldset: Option<&str>) -> Result<models::GetReceivedDocumentResponse, Error<GetReceivedDocumentError>> {
    let local_var_configuration = configuration;
...
pub async fn get_received_document_pre_create_info(configuration: &configuration::Configuration, company_id: i32, r#type: &str) -> Result<models::GetReceivedDocumentPreCreateInfoResponse, Error<GetReceivedDocumentPreCreateInfoError>> {
    let local_var_configuration = configuration;
...
pub async fn list_received_documents(configuration: &configuration::Configuration, company_id: i32, r#type: &str, fields: Option<&str>, fieldset: Option<&str>, sort: Option<&str>, page: Option<i32>, per_page: Option<u8>, q: Option<&str>) -> Result<models::ListReceivedDocumentsResponse, Error<ListReceivedDocumentsError>> {
    let local_var_configuration = configuration;
...
pub async fn modify_received_document(configuration: &configuration::Configuration, company_id: i32, document_id: i32, modify_received_document_request: Option<models::ModifyReceivedDocumentRequest>) -> Result<models::ModifyReceivedDocumentResponse, Error<ModifyReceivedDocumentError>> {
    let local_var_configuration = configuration;
...
pub async fn upload_received_document_attachment(configuration: &configuration::Configuration, company_id: i32, filename: Option<&str>, attachment: Option<std::path::PathBuf>) -> Result<models::UploadReceivedDocumentAttachmentResponse, Error<UploadReceivedDocumentAttachmentError>> {
    let local_var_configuration = configuration;
