...
pub async fn create_supplier(configuration: &configuration::Configuration, company_id: i32, create_supplier_request: Option<models::CreateSupplierRequest>) -> Result<models::CreateSupplierResponse, Error<CreateSupplierError>> {
...
pub async fn get_supplier(configuration: &configuration::Configuration, company_id: i32, supplier_id: i32, fields: Option<&str>, fieldset: Option<&str>) -> Result<models::GetSupplierResponse, Error<GetSupplierError>> {
    let local_var_configuration = configuration;
...
/// Lists the suppliers.
pub async fn list_suppliers(configuration: &configuration::Configuration, company_id: i32, fields: Option<&str>, fieldset: Option<&str>, sort: Option<&str>, page: Option<i32>, per_page: Option<u8>, q: Option<&str>) -> Result<models::ListSuppliersResponse, Error<ListSuppliersError>> {
    let local_var_configuration = configuration;
...
pub async fn modify_supplier(configuration: &configuration::Configuration, company_id: i32, supplier_id: i32, modify_supplier_request: Option<models::ModifySupplierRequest>) -> Result<models::ModifySupplierResponse, Error<ModifySupplierError>> {
    let local_var_configuration = configuration;
