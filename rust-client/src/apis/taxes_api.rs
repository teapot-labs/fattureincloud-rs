...
/// Creates a new F24.
pub async fn create_f24(configuration: &configuration::Configuration, company_id: i32, create_f24_request: Option<crate::models::CreateF24Request>) -> Result<crate::models::CreateF24Response, Error<CreateF24Error>> {
...
pub async fn get_f24(configuration: &configuration::Configuration, company_id: i32, document_id: i32, fields: Option<&str>, fieldset: Option<&str>) -> Result<crate::models::GetF24Response, Error<GetF24Error>> {
    let local_var_configuration = configuration;
...
/// Lists the F24s.
pub async fn list_f24(configuration: &configuration::Configuration, company_id: i32, fields: Option<&str>, fieldset: Option<&str>, sort: Option<&str>, page: Option<i32>, per_page: Option<u8>, q: Option<&str>) -> Result<crate::models::ListF24Response, Error<ListF24Error>> {
    let local_var_configuration = configuration;
...
pub async fn modify_f24(configuration: &configuration::Configuration, company_id: i32, document_id: i32, modify_f24_request: Option<crate::models::ModifyF24Request>) -> Result<crate::models::ModifyF24Response, Error<ModifyF24Error>> {
    let local_var_configuration = configuration;
...
pub async fn upload_f24_attachment(configuration: &configuration::Configuration, company_id: i32, filename: Option<&str>, attachment: Option<std::path::PathBuf>) -> Result<crate::models::UploadF24AttachmentResponse, Error<UploadF24AttachmentError>> {
    let local_var_configuration = configuration;
