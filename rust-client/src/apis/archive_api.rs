...
pub async fn create_archive_document(configuration: &configuration::Configuration, company_id: i32, create_archive_document_request: Option<models::CreateArchiveDocumentRequest>) -> Result<models::CreateArchiveDocumentResponse, Error<CreateArchiveDocumentError>> {
...
pub async fn get_archive_document(configuration: &configuration::Configuration, company_id: i32, document_id: i32, fields: Option<&str>, fieldset: Option<&str>) -> Result<models::GetArchiveDocumentResponse, Error<GetArchiveDocumentError>> {
    let local_var_configuration = configuration;
...
pub async fn list_archive_documents(configuration: &configuration::Configuration, company_id: i32, fields: Option<&str>, fieldset: Option<&str>, sort: Option<&str>, page: Option<i32>, per_page: Option<u8>, q: Option<&str>) -> Result<models::ListArchiveDocumentsResponse, Error<ListArchiveDocumentsError>> {
    let local_var_configuration = configuration;
...
pub async fn modify_archive_document(configuration: &configuration::Configuration, company_id: i32, document_id: i32, modify_archive_document_request: Option<models::ModifyArchiveDocumentRequest>) -> Result<models::ModifyArchiveDocumentResponse, Error<ModifyArchiveDocumentError>> {
    let local_var_configuration = configuration;
...
pub async fn upload_archive_document_attachment(configuration: &configuration::Configuration, company_id: i32, filename: Option<&str>, attachment: Option<std::path::PathBuf>) -> Result<models::UploadArchiveAttachmentResponse, Error<UploadArchiveDocumentAttachmentError>> {
    let local_var_configuration = configuration;
