...
pub async fn create_issued_document(configuration: &configuration::Configuration, company_id: i32, create_issued_document_request: Option<crate::models::CreateIssuedDocumentRequest>) -> Result<crate::models::CreateIssuedDocumentResponse, Error<CreateIssuedDocumentError>> {
...
pub async fn get_email_data(configuration: &configuration::Configuration, company_id: i32, document_id: i32) -> Result<crate::models::GetEmailDataResponse, Error<GetEmailDataError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issued_document(configuration: &configuration::Configuration, company_id: i32, document_id: i32, fields: Option<&str>, fieldset: Option<&str>) -> Result<crate::models::GetIssuedDocumentResponse, Error<GetIssuedDocumentError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issued_document_pre_create_info(configuration: &configuration::Configuration, company_id: i32, r#type: &str) -> Result<crate::models::GetIssuedDocumentPreCreateInfoResponse, Error<GetIssuedDocumentPreCreateInfoError>> {
    let local_var_configuration = configuration;
...
pub async fn get_new_issued_document_totals(configuration: &configuration::Configuration, company_id: i32, get_new_issued_document_totals_request: Option<crate::models::GetNewIssuedDocumentTotalsRequest>) -> Result<crate::models::GetNewIssuedDocumentTotalsResponse, Error<GetNewIssuedDocumentTotalsError>> {
    let local_var_configuration = configuration;
...
pub async fn join_issued_documents(configuration: &configuration::Configuration, company_id: i32, ids: &str, group: Option<i32>, e_invoice: Option<i32>) -> Result<crate::models::JoinIssuedDocumentsResponse, Error<JoinIssuedDocumentsError>> {
    let local_var_configuration = configuration;
...
pub async fn list_issued_documents(configuration: &configuration::Configuration, company_id: i32, r#type: &str, fields: Option<&str>, fieldset: Option<&str>, sort: Option<&str>, page: Option<i32>, per_page: Option<u8>, q: Option<&str>, inclusive: Option<i32>) -> Result<crate::models::ListIssuedDocumentsResponse, Error<ListIssuedDocumentsError>> {
    let local_var_configuration = configuration;
...
pub async fn modify_issued_document(configuration: &configuration::Configuration, company_id: i32, document_id: i32, modify_issued_document_request: Option<crate::models::ModifyIssuedDocumentRequest>) -> Result<crate::models::ModifyIssuedDocumentResponse, Error<ModifyIssuedDocumentError>> {
    let local_var_configuration = configuration;
...
pub async fn schedule_email(configuration: &configuration::Configuration, company_id: i32, document_id: i32, schedule_email_request: Option<crate::models::ScheduleEmailRequest>) -> Result<(), Error<ScheduleEmailError>> {
    let local_var_configuration = configuration;
...
pub async fn transform_issued_document(configuration: &configuration::Configuration, company_id: i32, original_document_id: i32, new_type: &str, e_invoice: Option<i32>, transform_keep_copy: Option<i32>) -> Result<crate::models::TransformIssuedDocumentResponse, Error<TransformIssuedDocumentError>> {
    let local_var_configuration = configuration;
...
pub async fn upload_issued_document_attachment(configuration: &configuration::Configuration, company_id: i32, filename: Option<&str>, attachment: Option<std::path::PathBuf>) -> Result<crate::models::UploadIssuedDocumentAttachmentResponse, Error<UploadIssuedDocumentAttachmentError>> {
    let local_var_configuration = configuration;
