...
pub struct Product {
    ...
    pub default_vat: Option<Option<Box<crate::models::VatType>>>,
    /// Product net cost
    ...
    pub stock_initial: Option<Option<f32>>,
