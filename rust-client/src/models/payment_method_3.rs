...
/// PaymentMethod3 : [Only for client] Client default payment method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct PaymentMethod3 {
    /// Payment method id
    ...
    pub default_payment_account: Option<Option<Box<crate::models::PaymentAccount1>>>,
    /// Payment method details
    #[serde(rename = "details", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub details: Option<Option<Vec<crate::models::PaymentMethodDetails>>>,
...
impl PaymentMethod3 {
    ...
    pub fn new(name: String) -> PaymentMethod3 {
        PaymentMethod3 {
            id: None,
            name,
            r#type: None,
