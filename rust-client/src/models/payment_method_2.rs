...
/// PaymentMethod2 : [Only for client] Client default payment method



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct PaymentMethod2 {
    /// Payment method id
    ...
    pub default_payment_account: Option<Option<Box<crate::models::PaymentAccount>>>,
