...
pub struct CashbookEntry1 {
    ...
    pub document: Option<Box<models::CashbookEntry1Document>>,
    /// [Only for cashbook entry in] Cashbook total amount in
    #[serde(rename = "amount_in", skip_serializing_if = "Option::is_none")]
    pub amount_in: Option<f64>,
    #[serde(rename = "payment_account_in", skip_serializing_if = "Option::is_none")]
    pub payment_account_in: Option<Box<models::PaymentAccount5>>,
    /// [Only for cashbook entry out] Cashbook total amount out
    #[serde(rename = "amount_out", skip_serializing_if = "Option::is_none")]
    pub amount_out: Option<f64>,
    #[serde(rename = "payment_account_out", skip_serializing_if = "Option::is_none")]
    pub payment_account_out: Option<Box<models::PaymentAccount6>>,
}
