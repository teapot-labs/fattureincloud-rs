...
pub struct EmailSchedule {
    ...
    pub include: Box<crate::models::EmailScheduleInclude>,
...
impl EmailSchedule {
    pub fn new(recipient_email: String, subject: String, body: String, include: crate::models::EmailScheduleInclude, attach_pdf: bool, send_copy: bool) -> EmailSchedule {
        EmailSchedule {
            sender_id: None,
            sender_email: None,
            recipient_email,
