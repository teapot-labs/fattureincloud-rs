...
pub struct IssuedDocumentPreCreateInfoItemsDefaultValues {
...
impl IssuedDocumentPreCreateInfoItemsDefaultValues {
    /// Issued document items default values
    pub fn new() -> IssuedDocumentPreCreateInfoItemsDefaultValues {
