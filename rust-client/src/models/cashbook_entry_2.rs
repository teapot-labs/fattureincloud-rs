...
pub struct CashbookEntry2 {
    ...
    pub document: Option<Option<Box<crate::models::CashbookEntryDocument>>>,
    ...
    pub payment_account_in: Option<Option<Box<crate::models::PaymentAccount3>>>,
    ...
    pub payment_account_out: Option<Option<Box<crate::models::PaymentAccount4>>>,
}

impl CashbookEntry2 {
    pub fn new() -> CashbookEntry2 {
        CashbookEntry2 {
            id: None,
            date: None,
            description: None,
