...
pub struct WebhooksSubscription1 {
...
impl WebhooksSubscription1 {
    pub fn new() -> WebhooksSubscription1 {
...
pub enum Types {
    ...
    #[serde(rename = "it.fattureincloud.webhooks.issued_documents.e_invoices")]
    IssuedDocumentsPeriodEInvoices,
    #[serde(rename = "it.fattureincloud.webhooks.received_documents.e_invoices")]
    ReceivedDocumentsPeriodEInvoices,
}
