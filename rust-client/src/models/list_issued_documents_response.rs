...
pub struct ListIssuedDocumentsResponse {
    /// Current page number.
    ...
    pub data: Option<Option<Vec<crate::models::IssuedDocument>>>,
}

impl ListIssuedDocumentsResponse {
    pub fn new() -> ListIssuedDocumentsResponse {
