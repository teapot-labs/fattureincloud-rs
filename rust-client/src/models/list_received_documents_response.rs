...
pub struct ListReceivedDocumentsResponse {
    /// Current page number.
    ...
    pub data: Option<Option<Vec<crate::models::ReceivedDocument>>>,
}

impl ListReceivedDocumentsResponse {
    /// 
    pub fn new() -> ListReceivedDocumentsResponse {
        ListReceivedDocumentsResponse {
            current_page: None,
            first_page_url: None,
            from: None,
