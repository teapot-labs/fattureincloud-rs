...
pub struct IssuedDocumentTotals {
    ...
    pub amount_net_with_rivalsa: Option<Option<f32>>,
    ...
    pub taxable_amount: Option<Option<f32>>,
    ...
    pub not_taxable_amount: Option<Option<f32>>,
    ...
    pub taxable_amount_withholding_tax: Option<Option<f32>>,
    ...
    pub taxable_amount_other_withholding_tax: Option<Option<f32>>,
    ...
    pub amount_due: Option<Option<f32>>,
    ...
    pub payments_sum: Option<Option<f32>>,
    /// Issued document vat list
    #[serde(rename = "vat_list", skip_serializing_if = "Option::is_none")]
    pub vat_list: Option<::std::collections::HashMap<String, crate::models::VatList>>,
}
