...
pub struct CreateWebhooksSubscriptionResponse {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::WebhooksSubscription>>,
...
impl CreateWebhooksSubscriptionResponse {
    pub fn new() -> CreateWebhooksSubscriptionResponse {
