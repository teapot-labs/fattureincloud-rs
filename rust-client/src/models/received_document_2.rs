...
pub struct ReceivedDocument2 {
    ...
    pub amortization: Option<Option<f32>>,
    ...
    pub tax_deductibility: Option<Option<f32>>,
    ...
    pub vat_deductibility: Option<Option<f32>>,
    ...
    pub payments_list: Option<Option<Vec<crate::models::ReceivedDocumentPaymentsListItem>>>,
...
impl ReceivedDocument2 {
    pub fn new() -> ReceivedDocument2 {
        ReceivedDocument2 {
            id: None,
            r#type: None,
            entity: None,
