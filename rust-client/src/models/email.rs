...
pub struct Email {
    ...
    #[serde(rename = "recipient_status", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub recipient_status: Option<Option<RecipientStatus>>,
    ...
    pub attachments: Option<Option<Vec<crate::models::EmailAttachment>>>,
}
