...
pub struct ListF24Response {
    ...
    pub data: Option<Option<Vec<crate::models::F24>>>,
    #[serde(rename = "aggregated_data", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub aggregated_data: Option<Option<Box<crate::models::ListF24ResponseAggregatedData>>>,
}

impl ListF24Response {
    /// 
    pub fn new() -> ListF24Response {
        ListF24Response {
            current_page: None,
            first_page_url: None,
            from: None,
