...
pub struct ListArchiveDocumentsResponse {
    /// Current page number.
    ...
    pub data: Option<Option<Vec<crate::models::ArchiveDocument>>>,
}

impl ListArchiveDocumentsResponse {
    /// 
    pub fn new() -> ListArchiveDocumentsResponse {
        ListArchiveDocumentsResponse {
            current_page: None,
            first_page_url: None,
            from: None,
